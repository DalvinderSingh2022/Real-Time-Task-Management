...
const Home = () => {
  ...
  useEffect(() => {
    const taskCounts = tasksState.tasks.reduce(
      (acc, task) => {
    ...
    <article className={styles.article}>
      <section className={styles.graph}>
        ...
        <div className={`flex col gap ${styles.graph_wrapper}`}>
          <div className="total">
            <span className={styles.graph_total}>
          ...
          <div className={`flex ${styles.graph_bar}`}>
            <Link
              ...
              style={{
                width: `${
                  (completed / (completed + notStarted + progress)) * 100
                }%`,
            ...
            <Link
              ...
              style={{
                width: `${
                  (progress / (completed + notStarted + progress)) * 100
                }%`,
            ...
            <Link
              ...
              style={{
                width: `${
                  (notStarted / (completed + notStarted + progress)) * 100
                }%`,
        ...
        <div className={`flex col gap ${styles.graph_wrapper}`}>
          ...
          <div className={`flex ${styles.graph_bar}`}>
            <Link
              ...
              className={styles.bar_child}
              style={{
                width: `${(followers / (followers + following)) * 100}%`,
            ...
            <Link
              ...
              className={styles.bar_child}
              style={{
                width: `${(following / (following + followers)) * 100}%`,
      ...
      <section className={styles.tasks}>
        ...
        <div
          className={`flex col gap2 tasks_container ${tasksStyles.tasks_container} ${styles.tasks_wrapper}`}
        >
      ...
      <section className={styles.followers}>
        ...
        <div
          className={`flex gap2 wrap ${userSstyles.wrapper} ${styles.followers_wrapper}`}
        >
